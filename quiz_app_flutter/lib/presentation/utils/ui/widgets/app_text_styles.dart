...
class AppTextStyles {
  ...
  static Text quizBodyDesc(String text) => Text(
    text,
  ...
  // Small headline
  static Text headlineSmall(String text) => Text(
    text,
    style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w500),
  );

  // Result title
  static Text resultTitle(String text) => Text(
    text,
    style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
  );

  // Result section title
  static Text resultSectionTitle(String text) => Text(
    text,
